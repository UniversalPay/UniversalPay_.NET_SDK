//-----------------------------------------------------------------------
// <copyright file="AuthCall.cs" company="nodus">
...
namespace Turnkey
{
    ...
    /// Do auth action
    /// </summary>
    public class AuthCall : ApiCall
    {
        public AuthCall(ApplicationConfig config, Dictionary<String, String> inputParams) : base(config, inputParams)
        {
        ...
        protected override Dictionary<String, String> GetTokenParams(Dictionary<String, String> inputParams)
        {
            ...
            tokenParam.Add("action", ActionType.AUTH.GetCode());
